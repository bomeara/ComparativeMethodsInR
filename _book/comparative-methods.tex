...
version (see date above), check back soon!
...
\chapter{Compiling the book}\label{compiling-the-book}
...
\begin{verbatim}
## List of 4
##  $ edge       : int [1:8, 1:2] 6 7 7 6 8 8 9 9 7 1 ...
##  $ edge.length: num [1:8] 1.096 0.758 0.758 1.376 0.478 ...
##  $ tip.label  : chr [1:5] "t1" "t3" "t5" "t2" ...
##  $ Nnode      : int 4
...
\includegraphics{comparative-methods_files/figure-latex/unnamed-chunk-8-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rweird <-}\StringTok{ }\NormalTok{function() \{}
  \NormalTok{displacement <-}\StringTok{ }\DecValTok{0}
  \NormalTok{if(}\KeywordTok{runif}\NormalTok{(}\DecValTok{1}\NormalTok{,-}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{) <}\StringTok{ }\NormalTok{.}\DecValTok{1}\NormalTok{) \{}
    \NormalTok{displacement <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{7}\NormalTok{, }\DecValTok{3}\NormalTok{) +}\StringTok{ }\KeywordTok{runif}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{7}\NormalTok{)}
  \NormalTok{\} else \{}
    \NormalTok{displacement <-}\StringTok{ }\FloatTok{0.5} \NormalTok{*}\StringTok{ }\KeywordTok{rexp}\NormalTok{(}\DecValTok{1}\NormalTok{, }\FloatTok{0.3}\NormalTok{) -}\StringTok{ }\DecValTok{1}
  \NormalTok{\}}
  \NormalTok{displacement <-}\StringTok{ }\NormalTok{displacement +}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{runif}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{100}\NormalTok{) %%}\StringTok{ }\DecValTok{7}\NormalTok{)}
...
\includegraphics{comparative-methods_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\KeywordTok{plot}\NormalTok{(}\KeywordTok{cophylo}\NormalTok{(phy, gene.tree, }\KeywordTok{cbind}\NormalTok{(}\KeywordTok{sort}\NormalTok{(phy$tip.label), }\KeywordTok{sort}\NormalTok{(gene.tree$tip.label))))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{species.tree$edge.length <-}\StringTok{ }\NormalTok{species.tree$edge.length /}\StringTok{ }\NormalTok{(}\DecValTok{10}\NormalTok{*}\KeywordTok{max}\NormalTok{(}\KeywordTok{branching.times}\NormalTok{(species.tree)))}
\NormalTok{gene.tree <-}\StringTok{ }\KeywordTok{sim.coaltree.phylo}\NormalTok{(species.tree)}
\KeywordTok{plot}\NormalTok{(}\KeywordTok{cophylo}\NormalTok{(species.tree, gene.tree, }\KeywordTok{cbind}\NormalTok{(}\KeywordTok{sort}\NormalTok{(species.tree$tip.label), }\KeywordTok{sort}\NormalTok{(gene.tree$tip.label))))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tip.rows <-}\StringTok{ }\KeywordTok{which}\NormalTok{(species.tree$edge[,}\DecValTok{2}\NormalTok{]<=}\KeywordTok{Ntip}\NormalTok{(species.tree))}
\NormalTok{species.tree2 <-}\StringTok{ }\NormalTok{species.tree}
\NormalTok{species.tree2$edge.length[tip.rows] <-}\StringTok{ }\DecValTok{100} \NormalTok{+}\StringTok{ }\NormalTok{species.tree2$edge.length[tip.rows]}
\NormalTok{gene.tree2 <-}\StringTok{ }\KeywordTok{sim.coaltree.phylo}\NormalTok{(species.tree2)}
\KeywordTok{plot}\NormalTok{(}\KeywordTok{cophylo}\NormalTok{(species.tree2, gene.tree2, }\KeywordTok{cbind}\NormalTok{(}\KeywordTok{sort}\NormalTok{(species.tree2$tip.label), }\KeywordTok{sort}\NormalTok{(gene.tree2$tip.label))))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(}\KeywordTok{cophylo}\NormalTok{(species.tree2.clado, gene.tree2.clado, }\KeywordTok{cbind}\NormalTok{(}\KeywordTok{sort}\NormalTok{(species.tree2.clado$tip.label), }\KeywordTok{sort}\NormalTok{(gene.tree2.clado$tip.label))))}
\end{Highlighting}
\end{Shaded}
